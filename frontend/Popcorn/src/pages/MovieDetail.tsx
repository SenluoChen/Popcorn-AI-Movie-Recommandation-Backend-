...
export default function MovieDetail() {
  ...
  // Keep trailer flexible, but give the poster a more natural desktop width
  const mediaGridColumns = { xs: MEDIA_GRID_COLUMNS.xs, md: "minmax(320px, 440px) 1fr" };
                      ...
                      <Stack spacing={2}>
                        {flatrate.length ? (
                          <Box>
                            ...
                            <ProviderRow providers={flatrate} tileSize={56} />
                          </Box>
                        ) : null}
                        {flatrate.length && (rent.length || buy.length) ? (
                        ...
                        {rent.length ? (
                          <Box>
                            ...
                            <ProviderRow providers={rent} tileSize={56} />
                          </Box>
                        ) : null}
                        ...
                        {buy.length ? (
                          <Box>
                            ...
                            <ProviderRow providers={buy} tileSize={56} />
                          </Box>
                        ) : null}
                      </Stack>
                    ) : (
...
function ProviderRow({ providers, tileSize }: { providers: WatchProvider[]; tileSize?: number }) {
  const surface = "var(--surface)";
  const border = "var(--border-1)";
